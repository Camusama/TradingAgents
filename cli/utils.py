...
def select_shallow_thinking_agent(provider) -> str:
    ...
    SHALLOW_AGENT_OPTIONS = {
        "openai": [
            ("qwen-max - Compact model with good performance", "qwen-max"),
            ("qwen-plus - Standard model with solid capabilities", "qwen-plus"),
            ("qwen-turbo - Specialized reasoning model (compact)", "qwen-turbo"),
            ("qwen-long - Advanced reasoning model (lightweight)", "qwen-long"),
        ],
        "anthropic": [
            (
